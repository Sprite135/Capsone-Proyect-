...
BEGIN
    ...
    (
        ...
        SeaceEntityAcronym NVARCHAR(100) NOT NULL DEFAULT '',
        SeaceDepartment NVARCHAR(100) NOT NULL DEFAULT '',
        SeaceProvince NVARCHAR(100) NOT NULL DEFAULT '',
        SeaceDistrict NVARCHAR(100) NOT NULL DEFAULT '',
...
BEGIN
    ...
    (
        ...
        SeaceIndex INT NULL,
        SelectionType NVARCHAR(200) NOT NULL CONSTRAINT DF_Opportunities_SelectionType DEFAULT '',
        ConvocationNumber NVARCHAR(50) NOT NULL CONSTRAINT DF_Opportunities_ConvocationNumber DEFAULT '',
        ApplicableRegulation NVARCHAR(500) NOT NULL CONSTRAINT DF_Opportunities_ApplicableRegulation DEFAULT '',
        SeaceVersion NVARCHAR(50) NOT NULL CONSTRAINT DF_Opportunities_SeaceVersion DEFAULT '',
        EntityLegalAddress NVARCHAR(500) NOT NULL CONSTRAINT DF_Opportunities_EntityLegalAddress DEFAULT '',
        EntityWebsite NVARCHAR(300) NOT NULL CONSTRAINT DF_Opportunities_EntityWebsite DEFAULT '',
        EntityPhone NVARCHAR(100) NOT NULL CONSTRAINT DF_Opportunities_EntityPhone DEFAULT '',
        ContractObject NVARCHAR(200) NOT NULL CONSTRAINT DF_Opportunities_ContractObject DEFAULT '',
        ParticipationCost NVARCHAR(100) NOT NULL CONSTRAINT DF_Opportunities_ParticipationCost DEFAULT '',
        BasesReproductionCost NVARCHAR(100) NOT NULL CONSTRAINT DF_Opportunities_BasesReproductionCost DEFAULT '',
        SeaceDetailJson NVARCHAR(MAX) NOT NULL CONSTRAINT DF_Opportunities_SeaceDetailJson DEFAULT '',
        SeaceScheduleJson NVARCHAR(MAX) NOT NULL CONSTRAINT DF_Opportunities_SeaceScheduleJson DEFAULT '',
        SeaceDocumentsJson NVARCHAR(MAX) NOT NULL CONSTRAINT DF_Opportunities_SeaceDocumentsJson DEFAULT '',
...
BEGIN
    INSERT INTO dbo.CompanyProfile (UserId, CompanyName, PreferredCategories, PreferredLocations, PreferredModalities, MinAmount, MaxAmount, IdealAmount, FavoriteEntities, ExcludedEntities, PreferredKeywords, ExcludedKeywords, SeaceObjectDescription, SeaceCallYear, SeaceContractObject, SeaceEntityAcronym, SeaceDepartment, SeaceProvince, SeaceDistrict, MinDaysToClose, MaxDaysToClose, IdealDaysToClose, CreatedAtUtc, UpdatedAtUtc)
    VALUES (
